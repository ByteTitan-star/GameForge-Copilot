...
const copy = {
  zh: {
    ...
    features: {
      eyebrow: '核心特性',
      title: '创作能力不止于生成',
      item1: { title: '自然语言驱动', body: '无需编写代码，通过描述玩法开始创作。' },
      item2: { title: '人机协同把关', body: 'AI 负责策划与生成，创作者决定最终方向。' },
      item3: { title: '浏览器原生', body: '无需额外安装，生成结果打开即玩。' },
      item4: { title: '作品管理与交付', body: '管理版本，并下载、发布和分享游戏作品。' },
    },
    video: {
      eyebrow: '开发游戏展示',
      title: '完整展示',
  ...
  en: {
    ...
    features: {
      ...
      title: 'Creation capabilities beyond generation',
      item1: { title: 'Natural-language driven', body: 'Start creating by describing gameplay instead of writing code.' },
      item2: { title: 'Human-guided AI', body: 'AI handles planning and generation while the creator controls the final direction.' },
      item3: { title: 'Browser native', body: 'Open and play generated results without extra installation.' },
      item4: { title: 'Manage and deliver', body: 'Manage versions, then download, publish, and share game creations.' },
    },
    video: {
