...
_REGISTRY: tuple[SkillMeta, ...] = (
    ...
    SkillMeta(
        ...
        kind="methodology",
        nodes=("art", "art_options", "art_detail"),
        description="Paper-cut / collage language for tactile, handmade worlds.",
        path="methodology/art/paper-craft/SKILL.md",
    ),
    SkillMeta(
        id="art/ink-wash",
        name="Ink Wash",
        kind="methodology",
        nodes=("art", "art_options", "art_detail"),
        description="Ink, wash, and negative space for quiet or period settings.",
        path="methodology/art/ink-wash/SKILL.md",
    ),
    SkillMeta(
        id="art/candy-arcade",
        name="Candy Arcade",
        kind="methodology",
        nodes=("art", "art_options", "art_detail"),
        description="Soft candy colors and sticker HUD for light arcade play.",
        path="methodology/art/candy-arcade/SKILL.md",
    ),
    SkillMeta(
        id="art/crt-analog",
        name="CRT Analog",
        kind="methodology",
        nodes=("art", "art_options", "art_detail"),
        description="Phosphor CRT / analog video look without cyber neon defaults.",
        path="methodology/art/crt-analog/SKILL.md",
    ),
    SkillMeta(
        id="code/canvas",
        name="Canvas Engine",
