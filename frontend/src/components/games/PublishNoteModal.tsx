      ...
      {open ? (
        ...
        >
          ...
          >
            ...
            <h3 className="mt-2 text-lg text-white">{t('publishModalTitle')}</h3>
            <p className="mt-1 text-sm text-white/50">{t('publishModalBody').replace('{title}', gameTitle)}</p>
            <label className="mt-4 block space-y-1.5 text-sm">
              <span className="text-white/45">{t('publishNoteLabel')}</span>
              <textarea
                value={note}
